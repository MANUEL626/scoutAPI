...
class LeadBase(BaseModel):
    ...
    # Typage metier
    lead_category: LeadCategory = LeadCategory.OTHER
    lead_intent: Optional[LeadIntent] = None
    demand_property_type: Optional[str] = None
    demand_location: Optional[str] = None
...
class Lead(LeadBase):
    ...
    email_valid_syntax: Optional[bool] = None
    email_domain_has_mx: Optional[bool] = None
    phone_is_valid: Optional[bool] = None
